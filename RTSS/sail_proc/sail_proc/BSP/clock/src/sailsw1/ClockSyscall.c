...
/**
  ...
  None.
*/
CLOCK_FUNC uint32 ClockSyscall_GetHandle
(
  ClockHandle *hClient,
...
/**
  ...
  None.
*/
CLOCK_FUNC uint32 ClockSyscall_GetClockId
(
  ClockHandle hClient,
  const char  *szName,
  ClockIdType *pId,
...
/**
  ...
  None.
*/
CLOCK_FUNC uint32 ClockSyscall_EnableClockEx
(
  ClockHandle hClient,
  ClockIdType ClockId,
  uint32_t nFlags,
...
/**
  ...
  SVC_SUCCESS
*/
CLOCK_FUNC uint32 ClockSyscall_DisableClockEx
(
  ClockHandle hClient,
  ClockIdType ClockId,
  uint32_t nFlags,
...
/**
  ...
  Clock_GetId
*/
CLOCK_FUNC uint32 ClockSyscall_SetClockFrequency
(
  ClockHandle hClient,
  ClockIdType ClockId,
  uint32_t nFreq,
...
/**
  ...
  Clock_GetId
*/
CLOCK_FUNC uint32 ClockSyscall_GetClockFrequency ( ClockHandle hClient,
                                        ClockIdType ClockId,
...
/**
  ...
  Clock_IsOn
*/
CLOCK_FUNC uint32 ClockSyscall_IsClockEnabled ( ClockHandle hClient,
                                     ClockIdType ClockId,
                                     bool *pbIsEnabled,
                                     sailbsp_svc_rsp_t *rsp )
{
...
/**
  ...
  Clock_IsEnabled
*/
CLOCK_FUNC uint32 ClockSyscall_IsClockOn ( ClockHandle hClient,
                                ClockIdType ClockId,
                                bool *pbIsOn,
                                sailbsp_svc_rsp_t *rsp )
{
...
/**
  ...
  Clock_GetId
*/
CLOCK_FUNC uint32 ClockSyscall_ResetBlock ( ClockHandle hClient,
                                 ClockIdType ClockId,
...
/**
  ...
  Clock_GetId
*/
CLOCK_FUNC uint32 ClockSyscall_Reset ( ClockHandle hClient,
                            ClockIdType ClockId,
                            ClockResetType eReset,
                            sailbsp_svc_rsp_t *rsp )
{
...
/**
  ...
  None.
*/
CLOCK_FUNC uint32 ClockSyscall_SleepEntry( sailbsp_svc_rsp_t *rsp )
{
    /* rsp->data[0] return clock result */
...
/**
  ...
  None.
*/
CLOCK_FUNC uint32 ClockSyscall_SleepExit( sailbsp_svc_rsp_t *rsp )
{
    /* rsp->data[0] return clock result */
...
/* =========================================================================
**  Function : ClockSyscall_GetVoltageRailCorner
** =========================================================================*/
/**
  ...
  None.
*/
CLOCK_FUNC uint32 ClockSyscall_GetVoltageRailCorner ( ClockHandle hClient, const char *szName, rail_voltage_level   *eGetCorner,  sailbsp_svc_rsp_t *rsp )
{
    /* rsp->data[0] return clock result */
...
/*
 * uint32 ClockSyscall_SleepEntry ( sailbsp_svc_rsp_t *rsp )
 */
