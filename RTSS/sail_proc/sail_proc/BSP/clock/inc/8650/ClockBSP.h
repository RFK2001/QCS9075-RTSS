...
$Header: //components/dev/bsp.sail/1.0/rmunibyr.bsp.sail.1.0.rmunibyr_safertos1/clock/inc/8650/ClockBSP.h#1 $
...
struct ClockSourceNodeType
{
  ...
  uint32_t                          nRailMask;                     /**< Bitmask indicating the set of rails*/
