...
extern QueueHandle_t xSAILUpdaterTestRxQueueHandle;
...
SAILUpdaterStatusType_e xSAILUpdaterMsgCheckHeaderValidity(sailUpdaterMsgHeaderType* pReqMsg)
{
    ...
    {
        DEBUG_LOG(SAIL_ERROR, "xSAILUpdaterMsgCheckHeaderValidity: Error, Invalid Header CRC 0x%x calculated CRC 0x%x \n\r", tempCRC32, pReqMsg->headerCrc);
    ...
    {
        DEBUG_LOG(SAIL_ERROR, "xSAILUpdaterMsgCheckHeaderValidity: Error, Invalid Header Params direction 0x%x Status 0x%x Header size 0x%x \n\r", pReqMsg->direction, pReqMsg->status, pReqMsg->headerSize);
...
void vSAILUpdaterMsgProcessReqMsg(sailUpdaterMsgHeaderType* pReqMsg, sailUpdaterMsgHeaderType* pRspMsg)
{
    ...
    DEBUG_LOG(SAIL_WARNING,"vSAILUpdaterMsgProcessReqMsg: Processing MSG params headerCrc=0x%x headerSize=0x%x msgId=0x%x direction=0x%x status=0x%x\n\r", pReqMsg->headerCrc, pReqMsg->headerSize, pReqMsg->msgId, pReqMsg->direction, pReqMsg->status);
    ...
    switch (pReqMsg->msgId)
    {
        ...
        case SAIL_UPD_MSG_ID_CHECK_GPT:
            DEBUG_LOG(SAIL_WARNING,"vSAILUpdaterMsgProcessReqMsg: Processing MSG ID Check GPT \n\r");
            eStatus = xSAILUpdaterCoreProcessChkGPT(pReqMsg, pRspMsg);
            break;
        case SAIL_UPD_MSG_ID_READ_GPT:
            DEBUG_LOG(SAIL_WARNING,"vSAILUpdaterMsgProcessReqMsg: Processing MSG ID Read GPT \n\r");
            eStatus = xSAILUpdaterCoreProcessReadGPT(pReqMsg, pRspMsg);
            break;
        case SAIL_UPD_MSG_ID_WRITE_GPT:
            DEBUG_LOG(SAIL_WARNING,"vSAILUpdaterMsgProcessReqMsg: Processing MSG ID Write GPT \n\r");
            eStatus = xSAILUpdaterCoreProcessWriteGPT(pReqMsg, pRspMsg);
            break;
        case SAIL_UPD_MSG_ID_FIX_GPT:
            DEBUG_LOG(SAIL_WARNING,"vSAILUpdaterMsgProcessReqMsg: Processing MSG ID Fix GPT \n\r");
            eStatus = xSAILUpdaterCoreProcessFixGPT(pReqMsg, pRspMsg);
            break;
        case SAIL_UPD_MSG_ID_UPDATE_GPT:
            DEBUG_LOG(SAIL_WARNING,"vSAILUpdaterMsgProcessReqMsg: Processing MSG ID Update GPT \n\r");
            eStatus = xSAILUpdaterCoreProcessUpdateGPT(pReqMsg, pRspMsg);
            break;
        ...
        case SAIL_UPD_MSG_ID_GET_OTA_METADATA:
            DEBUG_LOG(SAIL_WARNING,"vSAILUpdaterMsgProcessReqMsg: Processing MSG ID Get OTA Metadata \n\r");
            eStatus = xSAILUpdaterCoreProcessGetOTAMeta(pReqMsg, pRspMsg);
            break;
        case SAIL_UPD_MSG_ID_SET_OTA_METADATA:
            DEBUG_LOG(SAIL_WARNING,"vSAILUpdaterMsgProcessReqMsg: Processing MSG ID Set OTA Metadata \n\r");
            eStatus = xSAILUpdaterCoreProcessSetOTAMeta(pReqMsg, pRspMsg);
            break;
        case SAIL_UPD_MSG_READ_OTA_METADATA:
            DEBUG_LOG(SAIL_WARNING,"vSAILUpdaterMsgProcessReqMsg: Processing MSG ID Read OTA Metadata \n\r");
            eStatus = xSAILUpdaterCoreProcessReadOTAMeta(pReqMsg, pRspMsg);
            break;
        case SAIL_UPD_MSG_WRITE_OTA_METADATA:
            DEBUG_LOG(SAIL_WARNING,"vSAILUpdaterMsgProcessReqMsg: Processing MSG ID Write OTA Metadata \n\r");
            eStatus = xSAILUpdaterCoreProcessWriteOTAMeta(pReqMsg, pRspMsg);
            break;
        case SAIL_UPD_MSG_ERASE_OTA_METADATA:
            DEBUG_LOG(SAIL_WARNING,"vSAILUpdaterMsgProcessReqMsg: Processing MSG ID Erase OTA Metadata \n\r");
            eStatus = xSAILUpdaterCoreProcessEraseOTAMeta(pReqMsg, pRspMsg);
            break;
        case SAIL_UPD_MSG_GET_OTA_METADATAINFO:
            DEBUG_LOG(SAIL_WARNING,"vSAILUpdaterMsgProcessReqMsg: Processing MSG ID Get OTA MetadataInfo \n\r");
            eStatus = xSAILUpdaterCoreProcessGetOTAMetaInfo(pReqMsg, pRspMsg);
            break;
        case SAIL_UPD_MSG_OTA_DONE:
            DEBUG_LOG(SAIL_WARNING,"vSAILUpdaterMsgProcessReqMsg: Processing MSG ID OTA Done \n\r");
            eStatus = xSAILUpdaterCoreProcessOTADone(pReqMsg, pRspMsg);
            break;
        case SAIL_UPD_MSG_REDUNDANCY_ESTABLISHED:
            DEBUG_LOG(SAIL_WARNING,"vSAILUpdaterMsgProcessReqMsg: Processing MSG ID Redundancy Established \n\r");
            eStatus = xSAILUpdaterCoreProcessRedundancy(pReqMsg, pRspMsg);
            break;
        case SAIL_UPD_MSG_ID_UPDATE_ARB:
            DEBUG_LOG(SAIL_WARNING,"vSAILUpdaterMsgProcessReqMsg: Processing MSG ID Update ARB \n\r");
            eStatus = xSAILUpdaterCoreProcessUpdateARB(pReqMsg, pRspMsg);
            break;
        case SAIL_UPD_MSG_ID_UPDATE_MRC:
            DEBUG_LOG(SAIL_WARNING,"vSAILUpdaterMsgProcessReqMsg: Processing MSG ID Update MRC \n\r");
            eStatus = xSAILUpdaterCoreProcessUpdateMRC(pReqMsg, pRspMsg);
            break; 
		case SAIL_UPD_MSG_GET_IMAGE_DIGEST:
            DEBUG_LOG(SAIL_WARNING,"vSAILUpdaterMsgProcessReqMsg: Processing MSG ID GET IMAGE DIGEST \n\r");
            eStatus = xSAILUpdaterCoreProcessGetImgDigest(pReqMsg, pRspMsg);
            break;
#ifdef SAILUPDATER_INJTEST_SRC_ENABLED
        case SAIL_UPD_MSG_TEST_ERROR_INJECTION:
            DEBUG_LOG(SAIL_WARNING,"vSAILUpdaterMsgProcessReqMsg: Processing MSG ID Test Injection Command \n\r");
            eStatus = xSAILUpdaterCoreProcessTestInjection(pReqMsg, pRspMsg);
            break;
#endif
...
int32 slMailboxWriteWrap(xMailboxExtclienttype MBclient_ID,uint32 num_item,uint8 *rbuff )
{
    ...
    {
        if(NULL != xSAILUpdaterTestRxQueueHandle)
        {
            xStatus = xFreeRTOSQueueSend( xSAILUpdaterTestRxQueueHandle, rbuff, pdMS_TO_TICKS( freertosMAX_DELAY ));
            DEBUG_LOG(SAIL_INFO,"slMailboxWriteWrap: xQueueSend returns %d \n\r",xStatus);
...
void vSAILUpdaterMsgSendResponse(sailUpdaterMsgHeaderType* pRspMsg)
{
    ...
    DEBUG_LOG(SAIL_WARNING, "vSAILUpdaterMsgSendResponse: Response MSG params headerCrc=0x%x headerSize=0x%x msgId=0x%x direction=0x%x status=0x%x\n\r", pRspMsg->headerCrc, pRspMsg->headerSize, pRspMsg->msgId, pRspMsg->direction, pRspMsg->status);

    /* Send the Response over Mailbox */
    if(slMailboxWriteWrap(MAILBOX_OTA,1,(uint8 *)pRspMsg) > 0)
    {
        /* Log Message sent */
        DEBUG_LOG(SAIL_WARNING,"vSAILUpdaterMsgSendResponse: Sent Response success \n\r");
    }
    else if( SAIL_UPD_MSG_ID_HELLO == pRspMsg->msgId )
	{
		/* Log Message sent */
        DEBUG_LOG(SAIL_WARNING,"vSAILUpdaterMsgSendResponse: ebusy, okay \n\r");
	}
	else
    {
        /* error in reading from mailbox. log and loop */
        DEBUG_LOG(SAIL_ERROR,"vSAILUpdaterMsgSendResponse: Error Writing to Queue/Mailbox \n\r");
