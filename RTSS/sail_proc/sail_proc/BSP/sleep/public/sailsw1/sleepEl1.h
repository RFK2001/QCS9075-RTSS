...
#ifndef __SLEEPEL1_H_
#define __SLEEPEL1_H_
...
/**
    @file  sleepEl1.h
    @brief Header file of Sleep driver where all required APIs are exposed from El1
...
/*
    ...
    $Header: //components/dev/bsp.sail/1.0/rmunibyr.bsp.sail.1.0.rmunibyr_safertos1/sleep/public/sailsw1/sleepEl1.h#1 $
