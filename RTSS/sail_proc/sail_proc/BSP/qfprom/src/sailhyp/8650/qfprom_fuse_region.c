...
/*===========================================================================
  ...
  $Header: //components/dev/bsp.sail/1.0/rmunibyr.bsp.sail.1.0.rmunibyr_safertos1/qfprom/src/sailhyp/8650/qfprom_fuse_region.c#1 $
...
const QFPROM_REGION_INFO qfprom_region_data[] = {
	{
		QFPROM_PRI_KEY_DERIVATION_KEY_REGION,                                                   /* Region Name */
		4,                                                                                      /* Size - how many rows region takes */
		QFPROM_FEC_NONE,                                                                        /* FEC type - bits that contain FEC */
		HWIO_SAILSS_SECURITY_CONTROL_QFPROM_RAW_PRI_KEY_DERIVATION_KEY_ROW0_LSB_ADDR,                                   /* Raw address of the region */
		HWIO_SAILSS_SECURITY_CONTROL_QFPROM_CORR_PRI_KEY_DERIVATION_KEY_ROW0_LSB_ADDR,                                  /* Corrected address of the region */
		HWIO_SAILSS_SECURITY_CONTROL_QFPROM_CORR_READ_PERMISSIONS_LSB_PRIMARY_KEY_DERIVATION_KEY_READ_DISABLE_BMSK,     /* Read permission */
		HWIO_SAILSS_SECURITY_CONTROL_QFPROM_CORR_WRITE_PERMISSIONS_LSB_PRIMARY_KEY_DERIVATION_KEY_WRITE_DISABLE_BMSK,   /* Write permission */
...

	{
		...
		24,                                                                                     /* Size - how many rows region takes */
		QFPROM_FEC_NONE,                                                                        /* FEC type - bits that contain FEC */
	...
	{
		QFPROM_SEC_KEY_DERIVATION_KEY_REGION,                                                   /* Region Name */
		5,                                                                                      /* Size - how many rows region takes */
		QFPROM_FEC_63_56,                                                                       /* FEC type - bits that contain FEC */
		HWIO_SAILSS_SECURITY_CONTROL_QFPROM_RAW_SEC_KEY_DERIVATION_KEY_ROW0_LSB_ADDR,                                   /* Raw address of the region */
		HWIO_SAILSS_SECURITY_CONTROL_QFPROM_CORR_SEC_KEY_DERIVATION_KEY_ROW0_LSB_ADDR,                                  /* Corrected address of the region */
		HWIO_SAILSS_SECURITY_CONTROL_QFPROM_CORR_READ_PERMISSIONS_LSB_SECONDARY_KEY_DERIVATION_KEY_READ_DISABLE_BMSK,   /* Read permission */
		HWIO_SAILSS_SECURITY_CONTROL_QFPROM_CORR_WRITE_PERMISSIONS_LSB_SECONDARY_KEY_DERIVATION_KEY_WRITE_DISABLE_BMSK, /* Write permission */
		QFPROM_ROW_LSB,                                                                         /* LSB or MSB of QFPROM permission region */
		true,                                                                                   /* Read Allow */
...

	{
		...
		21,                                                                                      /* Size - how many rows region takes */
		QFPROM_FEC_NONE,                                                                        /* FEC type - bits that contain FEC */
		...
		HWIO_SAILSS_SECURITY_CONTROL_QFPROM_CORR_READ_PERMISSIONS_MSB_OEM_SPARE_30_READ_DISABLE_BMSK,                   /* Read permission */
		HWIO_SAILSS_SECURITY_CONTROL_QFPROM_CORR_WRITE_PERMISSIONS_MSB_OEM_SPARE_30_WRITE_DISABLE_BMSK,                 /* Write permission */       //ToDo rrahul -- check why LSB BMSK is not available.
		QFPROM_ROW_MSB,                                                                         /* LSB or MSB of QFPROM permission region */
		true,                                                                                   /* Read Allow */
		32                                                                                      /* QFPROM Region Index */
	},

	{
		...
		HWIO_SAILSS_SECURITY_CONTROL_QFPROM_CORR_READ_PERMISSIONS_MSB_OEM_SPARE_31_READ_DISABLE_BMSK,                   /* Read permission */         //ToDo rrahul -- check why LSB BMSK is not available.
		HWIO_SAILSS_SECURITY_CONTROL_QFPROM_CORR_WRITE_PERMISSIONS_MSB_OEM_SPARE_31_WRITE_DISABLE_BMSK,                 /* Write permission */
		QFPROM_ROW_MSB,                                                                         /* LSB or MSB of QFPROM permission region */
		true,                                                                                   /* Read Allow */
		33                                                                                      /* QFPROM Region Index */
	},
