...
#define UCLIB_MINOR_VER   47
#define UCLIB_BUILD_VER   0

/****************************** Revision History ******************************/

/*********** UCLIB ver. 0.47.0 Release, 09/10/21 - 10:16 by bsharma ***********/

/*
commit a3d1543066b6015a67045cb288d6e535c287d991
Merge: debc79f 99c7bf5
Author: Aseem Brahma <abrahma@qti.qualcomm.com>
Date:   Fri Sep 10 10:14:52 2021 -0700

    Merge "Fix Ed25519 signature verification argument check"


commit 99c7bf5cc1571bc8ee6405ed09c43d00cc68c1e6
Author: Aseem Brahma <abrahma@qti.qualcomm.com>
Date:   Thu Sep 9 15:14:12 2021 -0700

    Fix Ed25519 signature verification argument check

    When performing signature verification the private key does not need to
    have been set.

    Change-Id: I556bddcc3f53626a076d501952a6f71721229e2d

commit debc79f3f7a611a17ea44d28bb60615c1f1a030a
Merge: 6b495c2 47dac3b
Author: Aseem Brahma <abrahma@qti.qualcomm.com>
Date:   Thu Sep 9 22:14:19 2021 -0700

    Merge "FIPS 140-3 requirement: zeroization of locally stored SSP"
...
commit 47dac3b0e154c5c2dc1acc94ecfafc40fb0ad5e7
Author: Bikash <bsharma@qti.qualcomm.com>
Date:   Thu Jul 22 16:41:36 2021 -0700

    FIPS 140-3 requirement: zeroization of locally stored SSP

    Clearing out local vars containing security sensitive parameters.
    Eliminate compiler optimization of the local vars so that they are
    properly cleared.

    Change-Id: Icebfb92be51a78c5df1afa2a57eb47b80b5d9bfb

commit fe677c0a7b23198b74ab87ed3c719ad3f56e01c4
Merge: 002a63a df238b1
Author: Aseem Brahma <abrahma@qti.qualcomm.com>
Date:   Tue Aug 10 12:03:16 2021 -0700

    Merge "Autogenerate files per variant in respective buildpath"


commit 002a63af565f922f05982a13fe8921cdcab91c4a
Merge: e5cdfdb 268cc2a
Author: Aseem Brahma <abrahma@qti.qualcomm.com>
Date:   Tue Aug 10 12:01:00 2021 -0700

    Merge "Revamp BAM callback handling."


commit df238b1a62e76c5786448a9609e365bd296c3c2e
Author: Bikash <bsharma@qti.qualcomm.com>
Date:   Wed May 19 20:24:18 2021 -0700

    Autogenerate files per variant in respective buildpath

    For images like mpss, where a single build command could build different
    variants, multiple Scons environment are active at the same time and
    they could be autogenerating or consuming autogenerated files at the same
    time. That can potentially create timing issues where one process could
    generate the files and just before it starts consuming them a second process
    could start overwriting it. The first process would find the files empty
    and miss compiling all sources. This could result in linking error
    later during build process.

    We had only accounted for auto-generating files in separate folders
    for different images like tz, commonlib, pbl, mpss etc. but now we need
    to account for variants within an image as well.

    Change-Id: I98f2432738e12066447498a6d130e15924fe234d

commit 268cc2af0fbe0bc4df7e681e9baa1cbe0d604141
Author: Bikash <bsharma@qti.qualcomm.com>
Date:   Wed May 19 15:44:20 2021 -0700

    Revamp BAM callback handling.

    Fix for CR 2944247. This was a subtle issue causing Uclib to
    get stuck waiting indefinitely for bam pipe callback.

    The failure was observed in this situation:
    - Cmd desc and Data desc were queued on TX pipe, thereby setting
      'tx_xfer=true' and 'tx_result_avail=failse'
    - BAM ISR callbacks (for desc-done and EOT) came in even before
      RX descriptors were queued
    - This caused the setting of 'tx_isr_result = UCLIB_SUCCESS' and
      'tx_result_avail = true'
    - This then caused CE_BAM_trigger_transfers_done_event to be
      called, which determined that 'tx_pipe_done' was true, and also
      that 'rx_pipe_done' was true because of the following condition
      '(false == cb_ctx->rx_xfer && !cb_ctx->rx_result_avail)'
    - There was no way to distinguish between RX transfers actually
      having completed and RX transfers not even being set up yet

    The solution was to simplify the event completion checking and use
    only tx-done/rx-done flags rather than (tx/rx-xfer + tx/rx_avail)
    flags. For cases where no RX is expected (for example HW unlock)
    the rx-done flag is set before queueing any descriptors.

    Change-Id: Iac1ba002c1aa089ee3c7d6e4a90bdae6047ccea3

commit e5cdfdbfe12e878d1f1cfe86db65046b933d14e2
Merge: f6c28cf 85a6c49
Author: Aseem Brahma <abrahma@qti.qualcomm.com>
Date:   Wed Aug 4 12:06:53 2021 -0700

    Merge "Modify CCM output length check to exclude tag"


commit f6c28cf31ecf6a3968d8cad8a57b5e88bbcce9b3
Merge: 65b8bdb f8d29dd
Author: Aseem Brahma <abrahma@qti.qualcomm.com>
Date:   Wed Aug 4 12:06:01 2021 -0700

    Merge "Fixed INCR_BIG_ENDIAN_CIPHER_IV() issue for HW ccm/gcm with large data."


commit f8d29dd68857facf10d7122469ae059f47babbd7
Author: Jieping Guo <jiepingg@qti.qualcomm.com>
Date:   Fri Jun 25 16:56:42 2021 -0700

    Fixed INCR_BIG_ENDIAN_CIPHER_IV() issue for HW ccm/gcm with large data.

    Change-Id: Ia421283c0980fb25b3396b9524ae112d39e3afdb

commit 85a6c498316569c8822c106893ea250c68b353ae
Author: Aseem Brahma <abrahma@qti.qualcomm.com>
Date:   Wed Jul 21 08:44:10 2021 -0700

    Modify CCM output length check to exclude tag

    For AES-CCM in HW, remove the check that the output buffer for
    encryption be large enough to accommodate the tag because we collect the tag
    into a separate buffer that is part of the internal cipher context.

    Change-Id: I07e6cd331b5231bfb9ded96e439e44f0a5f3d0a8

commit 65b8bdb7f5e0c00ff558ee7da1cd903eece2c4f3
Author: Aseem Brahma <abrahma@qti.qualcomm.com>
Date:   Wed Jun 30 13:20:18 2021 -0700

    Released uclib version 0.46.0. This is an autogenerated commit. Please do not edit commit msg.


commit f8cac1e8b11740bd9595c470e87f515e0eee50ce
Author: Aseem Brahma <abrahma@qti.qualcomm.com>
Date:   Fri Jun 25 14:04:24 2021 -0700

    Add support for retrieving a X25519 public key

    Ed25519 and X25519 keys are related but different. Ed25519 private keys
    mandate a SHA512 step which is not needed for X25519.

    Change-Id: I8d17be0cdac914ca8452cd792b207b75b6967554

commit 42a7d8c71fc679a5beed56c4de329ecb3806758b
Merge: 2eea909 7d944ce
Author: Aseem Brahma <abrahma@qti.qualcomm.com>
Date:   Mon Jun 21 15:47:15 2021 -0700

    Merge "Fix KW issues reported in ssg.boot.2.0."


commit 2eea9098aed594e0dc4b0aa56b7ee48ed32701a8
Merge: 764a21e e861779
Author: Aseem Brahma <abrahma@qti.qualcomm.com>
Date:   Wed Jun 9 21:45:37 2021 -0700

    Merge "Instrument PRNG driver for entropy collection."


commit 764a21ee3f056a45c5f9815d99c982d42292a200
Author: Jieping Guo <jiepingg@qti.qualcomm.com>
Date:   Mon May 24 14:37:50 2021 -0700

    Released uclib version 0.45.0. This is an autogenerated commit. Please do not edit commit msg.
    The CR used for deploy - CR2953208

    Change-Id: I87388abe8f931089816a68a5a3d6442a9f747517

commit 871d834c42d00837518ba8dfcda438595749c766
Merge: d9d44c3 b1e911c
Author: Aseem Brahma <abrahma@qti.qualcomm.com>
Date:   Thu May 20 13:25:37 2021 -0700

    Merge "Added mutex around ce clock disable calls"


commit e861779e05e199c3b38f00784615e12db3440fae
Author: Jonathan Childers <jchilder@qti.qualcomm.com>
Date:   Mon May 10 15:57:23 2021 -0700

    Instrument PRNG driver for entropy collection.

    Add ifdefs to rand_hw.c to easily enable entropy collection.

    Change-Id: I269e9bdd75e9e0cedfe01498b16b65b0f0dfcd30

commit 7d944cec81b08ce9384a10cf5b0579abb20f40f7
Author: Jieping Guo <jiepingg@qti.qualcomm.com>
Date:   Mon May 17 13:18:07 2021 -0700

    Fix KW issues reported in ssg.boot.2.0.

    Change-Id: I78cbf98d3eef339146ceb01b16437b9a5f693699
...
commit b1e911c02da98dcd6a9734f3a8844bc458c733a9
Author: Srikanth Vaindam <svaindam@qti.qualcomm.com>
Date:   Fri Feb 28 15:32:30 2020 +0530

    Added mutex around ce clock disable calls

    We have seen an issue on modem where there is a race condition.
    clk_ref is not getting updated properly with enable and disable calls.
    due to this sometimes clocks are not getting disabled even though cryto engine is done with its operation.
    Due to this device is not going to Vdd min (sleep).
    After adding mutex lock around clock disable, the issue is resolved.

    Change-Id: If7193a4ddeaccc3f0b1d444090ca365406ff7290
