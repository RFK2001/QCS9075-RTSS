...
/*===========================================================================
  ...
  $Header: //components/dev/ssg.tz/1.14/sunkum.ssg.tz.1.14.test_sep15/securemsm/secboot/env/xbl_sec/secboot_env_i.h#1 $
 ...
 */
#define secboot_tmr_get_timestamp()   (pbl_tmr_get_timestamp())
...
#define secboot_read_boot_config_force_msa_auth_en() \
	HWIO_INF(BOOT_CONFIG, FORCE_MSA_AUTH_EN )
...
#define secboot_read_oem_config_mrc_total_root_num() \
	HWIO_INF(OEM_CONFIG0, ROOT_CERT_TOTAL_NUM)
...
*/
#define secboot_read_soc_hw_family_num() (0)

/**
* @brief This function reads soc hw version, defined in secfuses
*/
#define secboot_read_soc_hw_device_num() (0)
