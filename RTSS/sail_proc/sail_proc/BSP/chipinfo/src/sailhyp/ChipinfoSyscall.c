...
uint32 ChipInfoSyscall_GetPlatformInfo(sailbsp_hvc_rsp_t *rsp)
{
...
/**
  ...
  None.
*/
uint32 ChipInfoSyscall_GetChipVersion(sailbsp_hvc_rsp_t *rsp)
{
...
/**
  ...
  None.
*/
uint32 ChipInfoSyscall_GetSailChipVersion(sailbsp_hvc_rsp_t *rsp)
{
...
/**
  ...
  None.
*/
uint32 ChipInfoSyscall_GetChipId(sailbsp_hvc_rsp_t *rsp)
{
...
/**
  ...
  None.
*/
uint32 ChipInfoSyscall_GetChipFamily(sailbsp_hvc_rsp_t *rsp)
{
