...
/**
  ...
  { u'explicit-addressing': True,
    ...
    u'modules': [u'IPC_CORE', u'IPC_CONFIG', u'IPC_TRACE'],
    u'output-fvals': True,
...
/*
  ...
  $Header: //components/dev/bsp.sail/1.0/smarru.bsp.sail.1.0.ref_2_1/ipcc/inc/IPCCHWIO.h#1 $
...
#define HWIO_IPC_SEND_OFFS(base,p,c)                                         (0x0000000c + 0x40000 * (p) + 0x1000 * (c))
...
#define HWIO_IPC_RECV_ID_RMSK                                                0xffffffffU
...
#define HWIO_IPC_TOP_MODE_MODE_BMSK                 0x1U
#define HWIO_IPC_TOP_MODE_MODE_SHFT                 0x0U
#define HWIO_IPC_TOP_MODE_MODE_LEGACY_MODE_FVAL        0x0U
#define HWIO_IPC_TOP_MODE_MODE_IPC_ROUTER_MODE_FVAL        0x1U

/*----------------------------------------------------------------------------
 * MODULE: IPC_TRACE
 *--------------------------------------------------------------------------*/

#define HWIO_IPC_TRACE_ENABLE_ADDR(x)              ((x) + 0x000fd000)
#define HWIO_IPC_TRACE_ENABLE_OFFS                 (0x00000000)
#define HWIO_IPC_TRACE_ENABLE_RMSK                        0x1
#define HWIO_IPC_TRACE_ENABLE_IN(x)      \
        in_dword(HWIO_IPC_TRACE_ENABLE_ADDR(x))
#define HWIO_IPC_TRACE_ENABLE_INM(x, m)      \
        in_dword_masked(HWIO_IPC_TRACE_ENABLE_ADDR(x), m)
#define HWIO_IPC_TRACE_ENABLE_OUT(x, v)      \
        out_dword(HWIO_IPC_TRACE_ENABLE_ADDR(x),v)
#define HWIO_IPC_TRACE_ENABLE_OUTM(x,m,v) \
        out_dword_masked_ns(HWIO_IPC_TRACE_ENABLE_ADDR(x),m,v,HWIO_IPC_TRACE_ENABLE_IN(x))
#define HWIO_IPC_TRACE_ENABLE_ENABLE_BMSK                 0x1U
#define HWIO_IPC_TRACE_ENABLE_ENABLE_SHFT                 0x0U
