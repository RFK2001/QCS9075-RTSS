...
#define GPIO_OS_UNUSED_PARAMETER(x)           ((void)x)
/*=========================================================================
      Type Definitions
==========================================================================*/
...
typedef enum
{
  GPIOOS_TRIGGER_LEVEL=0,
  GPIOOS_TRIGGER_EDGE=1,
  GPIOOS_MAX
}
GPIOOS_TriggerType;
...
extern void GPIOOS_MutexDeinit 
( 
  mutex_t* pMutex 
);
...
extern void GPIOOS_MutexUnlock 
( 
  mutex_t* pMutex 
);
