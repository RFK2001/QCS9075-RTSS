# ==============================================================================
#
#  Copyright (c) 2020-2025, 2023 Qualcomm Technologies, Inc.
#  All Rights Reserved.
...
def print_help():
    print (
        "SWIV build utility\n"
        "Usage: python swiv_build_utility.py -i <input_image> -o <output_image> -v <vaddr> -p <paddr> -l\n\n"
        "Options:\n"
        "-h, --help             Print this help.\n"
        "-i, --input_image      Image to encrypt.\n"
        "-o, --output_image     Output image.\n"
        "-l, --loadable         Make the SWIV segment loadable. Should be omitted if unloadable segment is required.\n"
        "-v, --vaddr            Virtual address of the SWIV segment.\n"
        "-p, --paddr            Physical address of the SWIV segment.\n"
        "-a, --align            For loadable SWIV segment only. Customize the alignment value(in HEX format) for loadable swiv seg. default: 0x4\n"
        "-d, --paddingto        For loadable SWIV segment only. Customize the final SWIV seg size in HEX format. Add padding bytes(0) to increase the seg size to reach the given value, default and minimum value is 0x10\n"
        "-b, --binary           Output the SWIV as binary\n"
    )
...
def main(argv):
    ...
    align = 0x4
    try:
        opts, args = getopt.getopt(argv, "hi:o:lv:p:a:d:b", ["help", "input_image=", "ouput_image=", "loadable", "vaddr=", "paddr=", "align=", "paddingto=", "binary"])
